...
int main()
{
    ...
    std::cout << std::endl <<  "Sortowanie bąbelkowe (Bubble Sort)" << std::endl;
    wypelnij_tablice(t, SIZE);
    wydrukuj_tablice(t, SIZE);
    sortowanie_babelkowe(t, SIZE);
    wydrukuj_tablice(t, SIZE);

    std::cout << std::endl << "Sortowanie przez scalanie (Merge Sort)" << std::endl;
    wypelnij_tablice(t, SIZE);
    wydrukuj_tablice(t, SIZE);
    sortowanie_przez_scalanie(t, SIZE);
    wydrukuj_tablice(t, SIZE);

    std::cout << std::endl <<  "Sortowanie szybkie (Quick Sort)" << std::endl;
    wypelnij_tablice(t, SIZE);
    wydrukuj_tablice(t, SIZE);
    sortowanie_szybkie(t, SIZE);
    wydrukuj_tablice(t, SIZE);

    std::cout << std::endl <<  "Sortowanie przez wstrząsanie (Cocktail Shaker Sort)" << std::endl;
    wypelnij_tablice(t, SIZE);
    wydrukuj_tablice(t, SIZE);
    sortowanie_przez_wstrzasanie(t, SIZE);
    wydrukuj_tablice(t, SIZE);

    std::cout << std::endl <<  "Sortowanie przez wstawianie (Insertion Sort)" << std::endl;
    wypelnij_tablice(t, SIZE);
    wydrukuj_tablice(t, SIZE);
    ...
    std::cout << std::endl << "Tablica dla wyszukiwania" << std::endl;
    ...
    std::cout << std::endl << "Wyszukiwanie binarne" << std::endl;
    ...
    std::cout << std::endl <<  "Wyszukiwanie liniowe" << std::endl;
    ...
    std::cout << std::endl <<  "Wyszukiwanie liniowe z wartownikiem" << std::endl;
    ...
    std::cout << std::endl << "Wyszukiwanie interpolacyjne oraz skokowe zakładają, że tablica jest posortowana, więc sortujemy tablicą:" << std::endl;
    sortowanie_przez_wstawianie(tt, SIZE, tt_sorted);
    wydrukuj_tablice(tt_sorted, SIZE);

    std::cout << std::endl << "Wyszukiwanie interpolacyjne" << std::endl;
    ...
    std::cout << std::endl <<  "Wyszukiwanie skokowe" << std::endl;
